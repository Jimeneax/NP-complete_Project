...
python cs412_tsp_approx.py < test1/test1Input.txt > test1/test1Output.txt

# Test Case 2: Medium input
echo "Running Test Case 2: Medium input"
python cs412_tsp_approx.py < test2/test2Input.txt > test2/test2Output.txt

# Test Case 3: Large input
echo "Running Test Case 3: Large input"
python cs412_tsp_approx.py < test3/test3Input.txt > test3/test3Output.txt

# Test Case 4: High complexity input
echo "Running Test Case 4: High complexity input"
python cs412_tsp_approx.py < test4/test4Input.txt > test4/test4Output.txt
...
python cs412_tsp_approx.py < test5/test5Input.txt > test5/test5Output.txt
